...
<head>
    ...
    <meta name="description" content="Personal Website HTML Template">
        ...
        <nav class="navbar navbar-dropdown navbar-fixed-top navbar-expand-lg">
            <div class="navbar-brand">
                ...
                <span class="navbar-caption-wrap">
                    <a class="navbar-caption text-warning display-2" href="#">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav nav-dropdown" data-app-modern-menu="true">
                    <li class="nav-item">
                        <a class="nav-link link text-warning display-4" href="index.html">Galeria</a>
                    </li>
                    ...
                    <li class="nav-item dropdown open">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item text-warning display-4" href="#">Proyectos</a>
                            <a class="dropdown-item text-warning display-4" href="#">Iniciativas</a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link link dropdown-toggle text-warning display-4" href="https://mobirise.com"
                            aria-expanded="false" data-toggle="dropdown-submenu">Galeria</a>
            </div>
            </li>
            </ul>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center pt-5">
                ...
                <div class="col-md-6 row-item col-lg-3">
                    ...
                    <h4 class="mbr-fonts-style mbr-card-title display-5">VISUAL DESIGN</h4>
                    <p class="mbr-text mbr-fonts-style display-7">Oversaw all aspects of workshop job as simple HTML
                        resume developer and organisation administration consisting of economic, imaginative and also
                ...
                <div class="col-md-6 row-item col-lg-3">
                    ...
                    <p class="mbr-text mbr-fonts-style display-7">Familiar with various kinds of photography consisting
                        of fashion, wild animals and undersea due to HTML Resume Template</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container-fluid">
            <div class="row align-items-center content-row">
                <div class="col-lg-6 wrap-block">
                    ...
                    <h2 class="mbr-section-subtitle mbr-fonts-style mbr-light display-5">Empresario y Senador por Sonora</h2>
                    <h3 class="mbr-text mbr-fonts-style mbr-light display-7">
                        ...
                        En el senado de la republica soy integrante de las comisiones de Defensa Nacional, Marina,
                        Seguridad Publica y fungo como secretario de la comisión de Desarrollo Urbano, ordenamiento
                        territorial y vivienda.
                    </h3>
                    <div class="mbr-list counter-container mbr-fonts-style display-7">
                        <ul>
                            <li>Specialized in high-speed digital photography for motorsports from regional to
                                nationwide degree series</li>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 col-sm-12">
                    <h3 class="inner-text mbr-fonts-style content-text display-7">
                        <!-- <a href="https://mobirise.com" class="text-primary">Mobirise.com</a> -->
                    </h3>
                </div>
                <div class="social-media col-md-6 col-sm-12">
                    <ul>
                        ...
                        <li>
                            <a class="icon-transition" href="https://www.facebook.com/pages/Mobirise/1616226671953247">
                                <span class="mbr-iconfont socicon-facebook socicon" media-simple="true"></span>
                            </a>
                        </li>
                        <li>
                            <a class="icon-transition" href="https://plus.google.com/+Mobirise">
                                <span class="mbr-iconfont socicon-googleplus socicon" media-simple="true"></span>
                            </a>
                        </li>
                        <li>
                            <a class="icon-transition" href="https://www.instagram.com/mobirise/">
                                <span class="mbr-iconfont socicon-instagram socicon" media-simple="true"></span>
                            </a>
                        </li>
