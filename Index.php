...
<head>
    ...
    <meta name="description" content="Senador Arturo Bours Griffith">
            ...
            <div class="row align-items-center content-row">
                <div class="col-lg-6 wrap-block">
                    ...
                    <h3 class="mbr-text mbr-fonts-style mbr-light display-7">
                        ...
                        En el senado de la republica soy integrante de las comisiones de:
                    </h3>
                    ...
                    <h3 class="mbr-text mbr-fonts-style mbr-light display-7">
                        Y fungo como secretario de la comisión de Desarrollo Urbano, ordenamiento
                        territorial y vivienda.</h3>
